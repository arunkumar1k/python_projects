...
def load_data():
    path = Path.home() / "Downloads" / "people.xlsx"
...
forest_light_path = Path("/Users/arun/Downloads/forest-light.tcl")
forest_dark_path = Path("/Users/arun/Downloads/forest-dark.tcl")
